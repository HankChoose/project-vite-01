...
import styles from './sign-card-sign-up.module.scss';
...
export interface SignCardSignUpProps {
    className?: string;
 ...
 */
export const SignCardSignUp = ({ className, formType = 'signup' }: SignCardSignUpProps) => {
